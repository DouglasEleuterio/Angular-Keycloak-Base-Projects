...
import { DistanciaLocalidadeRoutingModule } from './distancia-localidade-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    SharedModule,
    RippleModule,
    DistanciaLocalidadeRoutingModule,
    ToggleButtonModule,
    AutoCompleteModule,
    TooltipModule,
    InputSwitchModule,
  ...
  providers: [DistanciaLocalidadeService, TreeDragDropService, TipoLocalidadeService, IntegradorLocalidadeService]
})
export class DistanciaLocalidadeModule {}
