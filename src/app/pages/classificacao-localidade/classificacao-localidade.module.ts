...
import { ClassificacaoLocalidadeRoutingModule } from './classificacao-localidade-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    SharedModule,
    RippleModule,
    ClassificacaoLocalidadeRoutingModule,
    ToggleButtonModule,
    AutoCompleteModule,
    TooltipModule,
    InputSwitchModule,
  ...
  providers: [ClassificacaoLocalidadeService, TreeDragDropService, TipoLocalidadeService]
})
export class ClassificacaoLocalidadeModule {}
