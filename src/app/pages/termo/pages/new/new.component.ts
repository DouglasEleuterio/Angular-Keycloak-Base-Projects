...
@Component({
  selector: 'app-new',
  template: '<app-termo-form [isNew]="true" #form></app-termo-form>',
...
export class NewComponent implements AfterViewInit {
  ...
  menuBack: AppMenuItem = AppMenuModel.itemTermos;
  ...
  ngAfterViewInit(): void {
    this.form.onSubmit = (entity: Termo, formGroup) => this.onSubmit(entity, formGroup);
    this.form.onCancel = () => this.router.navigate(this.menuBack.routerLink).then();
  }

  onSubmit(entity: Termo, formGroup: FormGroup): void {
      ...
      .subscribe({
        next: () => {
          this.router
            ...
            .then(() => this.alertService.defaultSuccess(this.translateService.instant('termo.message.success'.toUpperCase())));
        },
        error: error => {
