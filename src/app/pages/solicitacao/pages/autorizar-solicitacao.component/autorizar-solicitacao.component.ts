...
@Component({
  selector: 'app-autorizar-solicitacao-form',
  templateUrl: './autorizar-solicitacao.component.html',
  styleUrls: ['autorizar-solicitacao.component.scss']
})
export class AutorizacaoComponent extends BaseFormComponent implements OnInit, AfterViewInit {
  @Input() isNew: boolean;
            ...
            this.router
              ...
              .then(() =>
                this.alertService.error(
                  ...
                  this.translateService.instant('solicitacao.message.autorizar_error'.toUpperCase())
                )
              );
          }
  ...
  getSituacaoSolicitacao(): void {
    this.serviceSituacaoSolicitacao
      .findSituacaoSolicitacaoByFaseAndSituacaoChave(SituacaoSolicitacaoFaseEnum.CALCULO, SituacaoSolicitacaoEnum.AUTORIZADA_PARA_CALCULAR)
  ...
  ngAfterViewInit(): void {
    this.onSubmit = (entity: HistoricoSituacaoSolicitacao, formGroup) => {
      ...
      this.baseController.saveRedirect(
        ...
        'autorizar_solicitacao.message.success',
        this.menuBack,
        () => this.stopSending()
      );
    };
